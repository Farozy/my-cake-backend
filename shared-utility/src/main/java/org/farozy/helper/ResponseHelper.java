...
public class ResponseHelper {
    ...
    public static <T> ResponseEntity<ApiResponse<T>> buildResponseData(
    ...
    public static <T> ResponseEntity<ApiResponse<T>> buildResponseToken(
        ...
        return buildResponseToken(status, message, null, null);
    }

    public static <T> ResponseEntity<ApiResponse<T>> buildResponseToken(
            HttpStatus status, String message, T data
    ) {
        return buildResponseToken(status, message, data, null);
    }
